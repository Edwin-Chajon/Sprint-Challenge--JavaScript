...
const stegosaurus = {name:'stegosaurus', diet:'herbivorous', weigth: '2000kg', length: '9m', period: 'Late Jurassic'};
const velociraptor = {name:'velociraptor', diet:'carnivorous', weigth: '15kg', length: '1.8m', period: 'Late Cretaceous'};
...
let newArr = [];
graduates.forEach (function(currentValue){
  newArr.push(`${currentValue.university}`)
})
const unisWithUni = newArr.filter(s => s.includes('Uni'));
